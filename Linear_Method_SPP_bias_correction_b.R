...
#!/usr/bin/env Rscript
option_list = list(
  make_option(c("-o", "--corrected_chirps"), type="character", default="C:/bias_correction_SPP/Test_Data_Set/Nyando/corrected_chirps/", 
  ...
  make_option(c("-c", "--corrected_output"), type="character", default="C:/bias_correction_SPP/Test_Data_Set/Nyando/corrected_persian/", 
