...
option_list = list(
  ...
  make_option(c("-N", "--End_Year"), type="integer", default="2016", 
              help=" End year[default= %default]", metavar="integer"),
  make_option(c("-c", "--corrected_output"), type="character", default="C:/biased_correction/corrected_persian_quantile/", 
